package com.pieropan.notifacao.message;
...
public class MensagemConstante {
    ...
    public static final String PROPOSTA_NEGADA = "Prezado(a) %s, após análise interna não foi possível dar andamento a proposta.";
